...
examples=[
  ...
  Example('Have a good day!', 'Neutral'),
  Example('You are surpisingly articulate for a black person', 'Unintentionally racist'),
  Example('Stay down, you black scum', 'Intentionally racist')
]
